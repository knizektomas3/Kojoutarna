    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: 'var(--bg)' }}>
      <div className="card w-full max-w-sm p-8 flex flex-col items-center gap-6">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold" style={{ color: 'var(--text)' }}>Kojoutárna</h1>
          <p className="mt-1 text-sm" style={{ color: 'var(--text-muted)' }}>Evidence slepic a vajec</p>
        </div>
        <button
        ...
        <p className="text-xs text-center" style={{ color: 'var(--text-subtle)' }}>
          Každý uživatel vidí pouze svá vlastní data.
        </p>
      </div>
    </div>
  )
